...
import { Briefcase, Users, FileText, Plus, X, Calendar, MapPin, DollarSign } from 'lucide-react'
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link to="/candidates" className="text-sm font-medium text-gray-500 hover:text-gray-700" aria-label="View all candidates">View all</Link>
            </div>
            <div className="space-y-3">
